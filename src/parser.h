...
class yyParser {
    ...
    private:
        ...
        ast::decl *proc_decl();
        ast::proc_decl *proc_decl_0(const std::string &);
        ast::block *proc_decl_1();
        ast::decl *func_decl();
        ...
        void formal_param_sec_list_0(std::list<std::string> &);
        void formal_param_sec(std::list<std::string> &);
